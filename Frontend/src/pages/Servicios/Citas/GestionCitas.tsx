...
function GestionCitas() {
  ...
  const cargarCitas = async () => {
    ...
    try {
      ...
      console.log("Respuesta de obtenerCitas:", data)
      if (data.success) {
        setCitas(data.citas || [])
      } else {
        console.error("Error en obtenerCitas:", data.error)
      }
    } catch (error) {
  ...
  const handleSeleccionarCita = async (id_cita: number) => {
    ...
    try {
      ...
      console.log("Respuesta de inscribirseCita:", result)
      if (result.success) {
  ...
  const handleEliminarCita = async (id_cita: number) => {
    if (window.confirm('¿Estás seguro de eliminar esta cita?')) {
      try {
        ...
        console.log("Respuesta de eliminarCita:", result)
        if (result.success) {
